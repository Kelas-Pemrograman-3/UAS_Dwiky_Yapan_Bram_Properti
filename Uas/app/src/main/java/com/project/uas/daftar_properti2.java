...
public class daftar_properti2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_properti2);
        ...
        daftar1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                session.setSessid(0);
                Intent i = new Intent(daftar_properti2.this, menu.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public   void onBackPressed(){
        Intent back = new Intent(daftar_properti2.this,MainActivity.class);
        startActivity(back);
        finish();
    }
}
